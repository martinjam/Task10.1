...
public class NewFoodItem extends AppCompatActivity {
    ...
    ImageView foodImage;
    EditText foodTitleEditText, descriptionEditText, pickupEditText, quantityEditText, locationEditText, priceEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodSaveButton = findViewById(R.id.saveFoodButton);
        ...
        foodSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (title != null && date != null && location != null) {
                    long result = db.insertFood(new Food(date, title, description, pickup, quantity, location, bytes, price));
                    if (result > 0) {
